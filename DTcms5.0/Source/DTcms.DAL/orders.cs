                        ...
                        if (model.order_goods != null)
                        {
                            ...
                            foreach (Model.order_goods modelt in model.order_goods)
                            {
                                ...
                                if (modelt.goods_id > 0)
                                {
                                    ...
                                    strSql3.Append("update " + databaseprefix + "article_goods set stock_quantity=stock_quantity-@stock_quantity");
                                    strSql3.Append(" where id=@goods_id and channel_id=@channel_id and article_id=@article_id");
                                    ...
                                    parameters3[1].Value = modelt.goods_id;
                                    parameters3[2].Value = modelt.channel_id;
                                    parameters3[3].Value = modelt.article_id;
                                    ...
                                    strSql4.Append("stock_quantity=(select sum(stock_quantity) from " + databaseprefix + "article_goods where channel_id=@channel_id and article_id=@article_id)");
                                    strSql4.Append(" where id=@article_id");
                                    SqlParameter[] parameters4 = {
                                            new SqlParameter("@channel_id", SqlDbType.Int,4),
                                            new SqlParameter("@article_id", SqlDbType.Int,4)};
                                    parameters4[0].Value = modelt.channel_id;
