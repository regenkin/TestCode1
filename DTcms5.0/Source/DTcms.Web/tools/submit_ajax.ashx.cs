...
namespace DTcms.Web.tools
{
    ...
    public class submit_ajax : IHttpHandler, IRequiresSessionState
    {
        ...
        private void cart_goods_add(HttpContext context)
        {
            ...
            //统计购物车
            Web.UI.ShopCart.Add(channel_id, article_id, goods_id, quantity);
        ...
        private void cart_goods_update(HttpContext context)
        {
            ...
            Model.cart_keys model = Web.UI.ShopCart.Update(channel_id, article_id, goods_id, quantity);
            if (model != null)
            {
        ...
        private void cart_goods_delete(HttpContext context)
        {
            ...
            Web.UI.ShopCart.Clear(channel_id, article_id, goods_id);
