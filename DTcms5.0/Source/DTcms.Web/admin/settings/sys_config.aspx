...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">尚未申请？<a href="http://www.dtcms.net" target="_blank">请点击这里注册</a></span>
    </dd>
  </dl>
  <dl>
    <dt>短信API地址</dt>
  ...
  <dl>
    ...
    <dd>
      ...
      如果您尚未申请开通，<a href="http://www.dtcms.net" target="_blank">请点击这里注册</a>成功后填写您的用户名和通讯密钥均可正常使用。
    </dd>
  </dl>
</div>
<!--/手机短信设置-->
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        <asp:RadioButtonList ID="fileserver" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
        <asp:ListItem Value="localhost" Selected="True">本地存储</asp:ListItem>
        <asp:ListItem Value="aliyun">阿里云OSS</asp:ListItem>
        </asp:RadioButtonList>
      </div>
  ...
  <dl>
    <dt>阿里云KeyId</dt>
    <dd>
      <asp:TextBox ID="osssecretid" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" " />
  ...
  <dl>
    <dt>阿里云SecretKey</dt>
    <dd>
      <asp:TextBox ID="osssecretkey" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" " />
  ...
  <dl>
    <dt>阿里云Bucket</dt>
    <dd>
      <asp:TextBox ID="ossbucket" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" " />
  ...
  <dl>
    <dt>阿里云EndPoint</dt>
    <dd>
      <asp:TextBox ID="ossendpoint" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" " />
  ...
  <dl>
    <dt>阿里云绑定域名</dt>
    <dd>
      <asp:TextBox ID="ossdomain" runat="server" CssClass="input normal" datatype="*0-255" sucmsg=" " />
