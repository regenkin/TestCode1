<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sound_list.aspx.cs" Inherits="DTcms.Web.admin.weixin.sound_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="sound_edit.aspx"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("keywords")%></td>
    <td><%#new DTcms.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id")))%></td>
    <td>
    ...
    <td align="center">
      <a href="sound_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
