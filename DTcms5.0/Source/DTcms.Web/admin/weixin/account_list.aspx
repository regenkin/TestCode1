<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="account_list.aspx.cs" Inherits="DTcms.Web.admin.weixin.account_list" ValidateRequest="false" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    <th width="8%">选择</th>
    <th align="left" width="12%">账号名称</th>
    <th align="left" width="10%">微信号</th>
    <th align="left">微信认证URL</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("name")%></td>
    <td><%#Eval("wxcode")%></td>
    <td><%#sysConfig.weburl + "/api/weixin/wx.aspx?uid=" + Eval("id")%></td>
    <td>
      <asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("sort_id")%>' CssClass="sort" onkeydown="return checkNumber(event);" />
    </td>
    <td align="center"><%#Convert.ToInt32(Eval("is_push")) == 1 ? "√" : "×"%></td>
    <td><%#string.Format("{0:g}", Eval("add_time"))%></td>
    <td align="center">
      <a href="account_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
