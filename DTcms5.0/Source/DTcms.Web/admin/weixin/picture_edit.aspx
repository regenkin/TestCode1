...
<!--导航栏-->
<div class="location">
  <a href="picture_list.aspx" class="back"><i class="iconfont icon-up"></i><span>返回列表页</span></a>
...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a class="selected" href="javascript:;">图文回复</a></li>
      </ul>
    </div>
  </div>
</div>
          ...
          <thead>
            ...
            <tbody id="item_box">
              ...
              <tr class="td_c">
                ...
                <td>
                  <a title="编辑" class="img-btn" onclick="showImgDialog(this);"><i class="iconfont icon-edit"></i></a>
