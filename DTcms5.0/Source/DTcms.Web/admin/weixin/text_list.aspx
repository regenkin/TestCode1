<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="text_list.aspx.cs" Inherits="DTcms.Web.admin.weixin.text_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="account_edit.aspx"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="15%">关健词</th>
    <th align="left">回复内容</th>
    <th align="left" width="8%">排序</th>
    <th width="10%">模糊区配</th>
    <th align="left" width="14%">添加时间</th>
    <th width="8%">操作</th>
  </tr>
</HeaderTemplate>
<ItemTemplate>
  <tr>
    ...
    <td><%#new DTcms.BLL.weixin_account().GetName(Convert.ToInt32(Eval("account_id")))%></td>
    <td><%#Eval("keywords")%></td>
    <td><%#Utils.DropHTML( new DTcms.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id"))), 30)%></td>
    <td>
      <asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("sort_id")%>' CssClass="sort" onkeydown="return checkNumber(event);" />
    </td>
    <td align="center"><%#Convert.ToInt32(Eval("is_like_query")) == 1 ? "√" : "×"%></td>
    <td><%#string.Format("{0:g}", Eval("add_time"))%></td>
    <td align="center">
      <a href="text_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
