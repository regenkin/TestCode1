    ...
    public partial class site_payment_edit : Web.UI.ManagePage
    {
        ...
        private void ShowFields(int _payment_id)
        {
            ...
            switch (payModel.api_path.ToLower())
            {
                ...
                case "wxapipay":
                    div_key1_container.Visible = true;
                    div_key1_title.Text = "商户号";
                    div_key1_tip.Text = "*微信支付的商户号";
                    div_key2_container.Visible = true;
                    div_key2_title.Text = "支付密钥";
                    div_key2_tip.Text = "*商户支付密钥，进入微信支付【账户设置】【API安全】设置";
                    div_key3_container.Visible = true;
                    div_key3_title.Text = "AppID";
                    div_key3_tip.Text = "*微信公众号的AppID(应用ID)";
                    div_key4_container.Visible = true;
                    div_key4_title.Text = "AppSecret";
                    div_key4_tip.Text = "*微信公众号的AppSecret(应用密钥)";
                    break;
                case "wxnatpay":
                    div_key1_container.Visible = true;
                    div_key1_title.Text = "商户号";
