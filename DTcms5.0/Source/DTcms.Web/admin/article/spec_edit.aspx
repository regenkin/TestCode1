<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="spec_edit.aspx.cs" Inherits="DTcms.Web.admin.article.spec_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="spec_list.aspx?channel_id=<%=channel_id %>" class="back"><i class="iconfont icon-up"></i><span>返回列表页</span></a>
  <a href="../center.aspx"><i class="iconfont icon-home"></i><span>首页</span></a>
  <i class="arrow iconfont icon-arrow-right"></i>
  <a href="spec_list.aspx?channel_id=<%=channel_id %>"><span>规格管理</span></a>
  <i class="arrow iconfont icon-arrow-right"></i>
  <span>编辑规格</span>
</div>
