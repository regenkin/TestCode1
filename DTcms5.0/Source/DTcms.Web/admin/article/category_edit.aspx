    ...
    $(function () {
        ...
        $("#brandAddButton").click(function () {
            ...
            var d = top.dialog({
                ...
                padding: 0,
                title: "品牌关联",
                url: 'dialog/dialog_category_brand.aspx?channel_id=<%=this.channel_id%>'
            }).showModal();
            //将容器对象传进去
            d.data = liObj;
        });
        ...
        $("#specAddButton").click(function () {
            ...
            var d = top.dialog({
                ...
                padding: 0,
                title: "规格关联",
                url: 'dialog/dialog_category_spec.aspx?channel_id=<%=this.channel_id%>'
            }).showModal();
            //将容器对象传进去
            d.data = liObj;
        });
    ...
    <dd>
      <div class="txt-item">
        <ul>
          ...
          <ItemTemplate>
          <li>
            <input name="hide_spec_id" type="hidden" value="<%#Eval("id")%>" />
