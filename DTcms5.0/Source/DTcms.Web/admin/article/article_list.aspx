      ...
      <div class="l-list">
        ...
        <div class="menu-list">
          <div class="rule-single-select">
            <asp:DropDownList ID="ddlWXPost" runat="server" AutoPostBack="True" onselectedindexchanged="ddlWXPost_SelectedIndexChanged"></asp:DropDownList>
          </div>
          <div class="rule-single-select">
      ...
      <li>
        <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
          ...
          <div class="foot">
            ...
            <a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Copy %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="复制"><i class="iconfont icon-copy"></i></a>
          </div>
        </div>
      </li>
  </ItemTemplate>
