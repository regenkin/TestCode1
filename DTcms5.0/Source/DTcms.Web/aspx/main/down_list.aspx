...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by DTcms Template Engine at 2017/5/4 3:55:43.
		本页面代码由DTcms模板引擎生成于 2017/5/4 3:55:43. 
	*/
	...
	templateBuilder.Append("\r\n      <!--小类-->\r\n    </p>\r\n    ");
	string category_nav = get_category_menu("down_list", category_id);
	...
	DataTable downList = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "down_list", category_id, "__id__");
	...
	templateBuilder.Append(" DTcms内测版：");
	templateBuilder.Append(Utils.GetVersion().ToString());

	templateBuilder.Append("</p>\r\n    <p>Copyright &copy; 2009-2017 dtcms.net Corporation,All Rights Reserved.</p>\r\n  </div>\r\n</div>");
