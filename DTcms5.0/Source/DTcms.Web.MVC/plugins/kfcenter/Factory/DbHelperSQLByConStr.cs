...
{
    public abstract class DbHelperSQLByConStr
    {
         //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        public static string connectionString = "server=tcp:119.29.91.240,50362;uid=sa;pwd=sa;database=kfcenter;Connection Lifetime=30";
        public DbHelperSQLByConStr() { }
        ...
        public static int GetMinID(string FieldName, string TableName)
        {
            ...
            object obj = DbHelperSQLByConStr.GetSingle(strsql);
            if (obj == null)
            {
                return 0;
            }
        ...
        {
            object obj = DbHelperSQLByConStr.GetSingle(strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
