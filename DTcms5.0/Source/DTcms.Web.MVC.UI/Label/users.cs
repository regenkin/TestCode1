...
namespace DTcms.Web.MVC.UI.Controllers {
   public partial class BaseController : Controller {
      ...
      /// <param name="strwhere">查询条件</param>
      /// <returns>DataTable</returns>
      public DataTable get_user_addr_book_list(int top, string strwhere) {
      ...
      /// <param name="totalcount">总记录数</param>
      /// <returns>DateTable</returns>
      public DataTable get_user_addr_book_list(int page_size, int page_index, string strwhere, out int totalcount) {
