...
namespace DTcms.API.Payment.alipaymb
{
    /// <summary>
    /// 类名：Submit
    /// 功能：支付宝各接口请求提交类
    ...
    public class Submit
    {
        ...
        public string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            //待请求参数数组
            ...
            sbHtml.Append("<form id='alipaysubmit' name='alipaysubmit' action='" + GATEWAY_NEW + "' method='" + strMethod.ToLower().Trim() + "'>");
            ...
            sbHtml.Append("<script>var queryParam='';");
            sbHtml.Append("Array.prototype.slice.call(document.querySelectorAll('input[type=hidden]')).forEach(function(ele){");
            sbHtml.Append("if(ele.name==='req_data'){");
            sbHtml.Append("queryParam+=ele.name+'='+ele.value+'&';");
            sbHtml.Append("}else{");
            sbHtml.Append("queryParam+=ele.name+'='+encodeURIComponent(ele.value)+'&';");
            sbHtml.Append("}");
            sbHtml.Append("});");
            sbHtml.Append("var gotoUrl=document.querySelector('#alipaysubmit').getAttribute('action')+queryParam;");
            sbHtml.Append("_AP.pay(gotoUrl);");
        ...
        public string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp)
        {
        ...
        /// <returns>支付宝处理结果</returns>
        public string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string fileName, byte[] data, string contentType, int lengthFile)
        {
