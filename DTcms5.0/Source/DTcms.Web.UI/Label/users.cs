...
namespace DTcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        /// <param name="strwhere">查询条件</param>
        /// <returns>DataTable</returns>
        protected DataTable get_user_addr_book_list(int top, string strwhere)
        {
            return new BLL.user_addr_book().GetList(top, strwhere, "is_default desc,id asc").Tables[0];
        }
        ...
        /// <param name="totalcount">总记录数</param>
        /// <returns>DateTable</returns>
        protected DataTable get_user_addr_book_list(int page_size, int page_index, string strwhere, out int totalcount)
        {
            return new BLL.user_addr_book().GetList(page_size, page_index, strwhere, "is_default desc,id asc", out totalcount).Tables[0];
        }
