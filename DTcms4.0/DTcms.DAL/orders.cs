    ...
    public partial class orders
    {
        ...
        public int Add(Model.orders model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@invoice_title", SqlDbType.NVarChar,100),
            ...
            if (model.order_goods != null)
            {
                ...
                foreach (Model.order_goods modelt in model.order_goods)
                {
                    ...
                    parameters2[3].Value = modelt.goods_no;
                    parameters2[4].Value = modelt.goods_title;
                    parameters2[5].Value = modelt.img_url;
                    parameters2[6].Value = modelt.spec_text;
                    parameters2[7].Value = modelt.goods_price;
