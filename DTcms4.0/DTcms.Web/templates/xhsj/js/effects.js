...
if ($(".response_shows_box .item").length > 1) {
    var _caseTime = 4000,_casePc = $(".response_shows_box .pc .pic .item"),_casePad = $(".response_shows_box .pad .pic .item"),_casePhone = $(".response_shows_box .phone .pic .item"),_caseLength = _casePc.length,_casePage = -1,_casePlay;
    ...
    function caseLoop() {
        ...
        var _pcH = -_casePc.height() * _casePage + "px",_padH = -_casePad.height() * _casePage + "px",_phoneH = -_casePhone.height() * _casePage + "px";
