...
//    if (moduleName == '表单字段' && fieldName == 'Sys_FieldId') { //模块字段
//        return row['Display'];
//    }
//    return value ? value : '';
//}
...
function AddDataSource(obj) {
    ...
    var toolbar = [{
        ...
        iconCls: "eu-icon-ok",
        handler: function (e) {
            var data = top.getCurrentDialogFrame()[0].contentWindow.GetNameValues();
    ...
    top.openDialog(title, url, toolbar, 500, 350, 'eu-icon-cog');
}