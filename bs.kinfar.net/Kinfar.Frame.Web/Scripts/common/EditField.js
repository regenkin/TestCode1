...
$(function () {
    ...
    try {
        ...
        if (formField && formField.ForeignModuleName && formField.ForeignTitleKey) { //针对外键智能提示
            ...
            FieldBindAutoCompletedByModuleName(tempDom, formField.ForeignModuleName, formField.ForeignTitleKey, null, function (dom, item, fieldName) {
                fieldDom.textbox("setValue", item["value"]);
                fieldDom.textbox("setText", item["text"]);
