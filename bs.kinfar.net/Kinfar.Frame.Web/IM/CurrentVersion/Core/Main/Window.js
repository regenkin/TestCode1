...
Window = function(config)
{
	...
	_config.AnchorStyle = IMCore.Utility.IsNull(config.AnchorStyle, IMCore.WindowAnchorStyle.Left | IMCore.WindowAnchorStyle.Top);
	...
	{
		var coord = IMCore.Utility.GetClientCoord(m_Browser);
		coord.X += x;
		coord.Y += y;
		var desktopCoord = IMCore.Utility.GetClientCoord(Desktop.GetDom());
	...
	{
		var e = new IMCore.Event(arguments[0]);
