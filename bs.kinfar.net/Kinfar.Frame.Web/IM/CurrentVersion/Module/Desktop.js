...
{Break();
    ...
    {
    	var width = (document.documentElement.clientWidth > 200) ? document.documentElement.clientWidth : 200;
...
function DesktopCtor()
{
	...
	This.EnterMove=function(cursor)
	{
		...
		IMCore.Utility.DisableSelect(m_MoveDiv, true);
...
{      
	...
	this.AddTask=function(dialog,title)
	{
		...
		items[IMCore.GenerateUniqueId()] = item;
		return item;
	}
