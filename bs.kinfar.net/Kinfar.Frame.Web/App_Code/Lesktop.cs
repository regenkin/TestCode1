...
///Lesktop 的摘要说明
/// </summary>
public class Lesktop : IHttpHandler
{
	public Lesktop()
	{
	}
			...
			case "Create":
				{
                    ...
                    String solution = String.Format(@"{0}\IM\Solution\{1}.lesktop", baseDirectory, path);
                    String backup = String.Format(@"{0}\IM\Solution\{1}.lesktop.bk", baseDirectory, path);
                    String code = String.Format(@"{0}\IM\{2}\Module\{1}.js", baseDirectory, path, Kinfar.Frame.IMCore.ServerImpl.Instance.ResPath);
                    String css = String.Format(@"{0}\IM\{2}\Themes\Default\{1}.css", baseDirectory, path, Kinfar.Frame.IMCore.ServerImpl.Instance.ResPath);
			...
			case "Save":
				{
					...
					//WriteFile(css, GetParam(doc.DocumentElement, "Css"));
					break;
				}
			}
		}
