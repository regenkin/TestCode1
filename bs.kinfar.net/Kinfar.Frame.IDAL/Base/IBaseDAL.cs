...
namespace Kinfar.Frame.IDAL.Base
{
    /// <summary>
    /// 数据层基接口
    /// </summary>
    ...
    public interface IBaseDAL<T> where T : class
    {
        ...
        /// <returns></returns>
        T GetEntity(out string errorMsg, Expression<Func<T, bool>> expression = null, string whereSql = null, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        T GetEntityById(out string errorMsg, object id, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        List<T> GetEntities(out string errorMsg, Expression<Func<T, bool>> expression = null, string whereSql = null, bool permissionFilter = true, List<string> orderFields = null, List<bool> isDescs = null, int? top = null, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        List<T> GetEntitiesByField(out string errorMsg, string fieldName, object fieldValue, bool permissionFilter = true, List<string> orderFields = null, List<bool> isDescs = null, int? top = null, bool references = false, string connString = null);
        ...
        /// <param name="connString">数据库连接字符串</param>
        /// <returns></returns>
        List<T> GetPageEntities(out long totalCount, out string errorMsg, bool permissionFilter = true, int pageIndex = 1, int pageSize = 10, List<string> orderFields = null, List<bool> isDescs = null, Expression<Func<T, bool>> expression = null, string whereSql = null, bool references = false, string connString = null);
