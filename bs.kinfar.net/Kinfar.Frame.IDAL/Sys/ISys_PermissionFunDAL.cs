...
namespace Kinfar.Frame.IDAL.Sys
{
    /// <summary>
    /// 功能权限自定义数据层接口
    /// </summary>
    public interface ISys_PermissionFunDAL
   { 
        /// <summary>
        ...
        Dictionary<Guid, bool> GetRoleFunPermissions(Guid roleId, int functionType);
        ...
        /// <returns></returns>
        Dictionary<Guid, bool> GetUserFunPermissions(Guid userId, int functionType);
    }
}
