...
namespace KfCrm.BLL
{
	...
	{
		private readonly KfCrm.DAL.CRM_product_category dal=new KfCrm.DAL.CRM_product_category();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public KfCrm.Model.CRM_product_category GetModelByCache(int id)
		{
			...
			return (KfCrm.Model.CRM_product_category)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<KfCrm.Model.CRM_product_category> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<KfCrm.Model.CRM_product_category> DataTableToList(DataTable dt)
		{
			List<KfCrm.Model.CRM_product_category> modelList = new List<KfCrm.Model.CRM_product_category>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				KfCrm.Model.CRM_product_category model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new KfCrm.Model.CRM_product_category();
