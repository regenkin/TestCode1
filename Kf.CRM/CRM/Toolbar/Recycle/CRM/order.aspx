...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '成交部门', name: 'F_dep_name', width: 80, align: 'left' },
                ...
                url: "../../../data/Crm_order.ashx?Action=grid&isdel=1&rnd=" + Math.random(),
        ...
        function toolbar() {
            $.getJSON("../../../data/toolbar.ashx?Action=GetSys&mid=50&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
