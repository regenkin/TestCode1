    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                checkbox: true,
                url: "../../../data/Crm_product_category.ashx?Action=grid&isdel=1&rnd=" + Math.random(),
        ...
        function toolbar() {
            $.getJSON("../../../data/toolbar.ashx?Action=GetSys&mid=54&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function doserch() {
            ...
            manager.setURL("../../../data/Crm_product_category.ashx?" + serchtxt);
    ...
    <div class="az">
        <form id='serchform'>
            <table style='width: 720px' class="bodytable1">
                <tr>
                    <td>
                        <div style='width: 60px; text-align: right; float: right'>类别名称：</div>
                    </td>
                    <td>
