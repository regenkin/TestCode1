...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    {
                        display: '新闻标题', name: 'news_title', width: 460, align: 'left', render: function (item) {
                    ...
                    {
                        display: '发布时间', name: 'news_time', width: 90, render: function (item) {
        ...
        function doserch() {
            ...
            manager.GetDataByURL("../../data/public_news.ashx?" + serchtxt);
        }
        ...
        //添加新闻
        function add() {
            f_openWindow("personal/message/news_add.aspx", "新增公告", 770, 510);
        }
        ...
        function edit() {
            ...
            if (row) {
                f_openWindow('personal/message/news_add.aspx?nid=' + row.id, "修改公告", 770, 510);
            }
            else {
