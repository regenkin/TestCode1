...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#mail_Blind").ligerTextBox({width:570,disabled:true});
            $.ajax({
                type: "GET",
                url: "../../data/mail.ashx", /* ע���������ֶ�ӦCS�ķ����� */
                data: { Action: 'view', nid: getparastr("nid"), rnd: Math.random() }, /* �ע�����ĸ�ʽ���� */
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (var n in rows) {
                        ...
                        else if (rows[n].recive_type_id == 3) {
                            blind_list += rows[n].receive_name + ";";
                        }
                    }
            ...
            $("#more_Blindpeople").bind("click", function () {
                f_alert($("#mail_Blind").val(), "Ͱ��");
            })
...
<body>
    <form id="form1" onsubmit="return false">
        ...
        <table style="border-collapse: collapse;margin:2px;width:738px;">
            <tr>
                <td colspan="2" class="table_title" style="border: 1px solid #b6d6e6; padding: 2px; line-height: 22px;">
                    ...
                    <div id="mail_title" style="text-align: left; font-size: x-large; font-weight: bold;width:680px;float:left;"></div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid #b6d6e6; padding: 2px; line-height: 22px;">
                    ...
                    <div style="width: 50px; float: left; padding-left: 2px;">
                        <input type="button" value="��" id="more_recieve"></div>
                </td>
            </tr>
            <tr>
                ...
                <td style="border: 1px solid #b6d6e6; padding: 2px; line-height: 22px;">
                    ...
                    <div style="width: 50px; float: left; padding-left: 2px;">
                        <input type="button" value="��" id="more_cc"></div>
                </td>
            </tr>
            <tr>
                <td style="border: 1px solid #b6d6e6; padding: 2px; line-height: 22px;">వ�ͣ�</td>
                <td style="border: 1px solid #b6d6e6; padding: 2px; line-height: 22px;">
                    <div style="width: 572px; float: left">
                        <input id="mail_Blind" type="text" />
                    </div>
                    <div style="width: 50px; float: left; padding-left: 2px;">
                        <input type="button" value="��" id="more_Blindpeople"></div>
                </td>
            </tr>
            <tr>
                <td style="border: 1px solid #b6d6e6; padding: 2px; line-height: 22px;">
        ...
        <div id="mail_content" style="height: 277px; overflow-y: scroll; margin: 2px;border:1px solid #b6d6e6;"></div>
