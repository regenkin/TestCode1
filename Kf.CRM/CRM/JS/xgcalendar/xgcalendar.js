...
; (function ($) {
    ...
    $.fn.bcalendar = function (option) {
        ...
        function BuildMonthDayEvent(e, cday, length) {
            ...
            var content = [];
            content.push(Tp(sp, { content: urldecode(cen) }));
            content.push(i);
            if (e.reevent)
            { content.push(i2); }
        ...
        function parseED(data) {
            if (data.length > 6) {
                var e = [];
                e.push(data[0], urldecode(data[1]), new Date(data[2]), new Date(data[3]), parseInt(data[4]), parseInt(data[5]), parseInt(data[6]), data[7] != undefined ? parseInt(data[7]) : -1, data[8] != undefined ? parseInt(data[8]) : 0, data[9], data[10]);
                return e;
            }
            return null;
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    ...
                    $("#bbit-cs-what").html(urldecode(data[1]));
