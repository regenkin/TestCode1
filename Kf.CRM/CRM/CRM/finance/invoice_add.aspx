        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#T_invoice_type').ligerComboBox({ width: 182, initValue:obj.invoice_type_id ,url: "../../data/Param_SysParam.ashx?Action=combo&parentid=7&rnd=" + Math.random() });
                }
            });
        }
    ...
    <form id="form1" onsubmit="return false">
        <div>
            <table style="width: 550px; margin: 5px;" class='bodytable1'>
                <tr>
                    <td colspan="4" class="table_title1">订单信息</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" class="table_title1">发票信息</td>
                </tr>
                <tr>
