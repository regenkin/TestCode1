...
<head>
    ...
    <script type="text/javascript">
        ...
        function test(GridData) {
            var series = [];
            var legend = [];
            var dt1 = typeof (GridData.Rows[0].dt1) != 'number' ? 0 : GridData.Rows[0].dt1;
            var dt2 = typeof (GridData.Rows[0].dt2) != 'number' ? 0 : GridData.Rows[0].dt2;
            series.push({ "name": '【客户】新增', "type": "bar", "barWidth": 80, "data": [ dt1, dt2] });
